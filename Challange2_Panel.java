...
public class Challange2_Panel extends JPanel implements MouseListener, MouseMotionListener{
	...
	//constructor
	 ...
	 public void Matrix()
	   ...
	   List<String[]> rowList = new ArrayList<String[]>();
		try (BufferedReader br = new BufferedReader(new FileReader("Step_Two.csv"))) {
		    String line;
